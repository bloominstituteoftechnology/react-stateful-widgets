...
// import { render } from "react-dom"; /* STEP 0 */


export default function Counter() {
  const [count, setCount] = useState(0);
  const evenN = (count % 2 === 0);
  // const oddN = (count % 2 === 1);
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: evenN === true ? 'royalblue' : 'crimson' /* STEP 2 */
  };
  ...
  return (
    <div className='widget-counter container'>
      ...
      <div id='count' style={style}>
        Number {count} is {evenN === true ? <p>even</p> : <p>odd</p>
