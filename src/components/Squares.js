...
export default function Squares() {
  ...
  var [squares, setSquares] = useState(listOfSquareIds);
  var [activeSquares, setactiveSquares] = useState(null)
  ...
  const markActive = id => {
    ...
    return  id !== activeSquares ? setactiveSquares(id) : setactiveSquares(null)
  };
