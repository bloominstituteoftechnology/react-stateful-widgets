...
export default function Squares() {
  ...
  const markActive = i => {     // i is the ID in the map function below AKA array above
    if (activeSquare != i){        
      return setActiveSquare(i)
    } else {
      return null;
    }
  };
      ...
      <div className='squares'>               
        {
          listOfSquareIds.map(id =>
            <div
              id={id}
              key={id}
              className={getClassName(id)}    // active
