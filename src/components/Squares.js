...
export default function Squares() {
  ...
  const markActive = id => {
    ...
    //   let elm = document.getElementsByClassName('square');
    //   const items = [...elm]; // turn collection into array
    //   setSquares(items);
    // }
    let foundItem = squares.find(elm => elm === id);
    setActiveSquare(foundItem);
