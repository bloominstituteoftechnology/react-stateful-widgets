...
export default function Squares() {
  ...
  const [sqrList, setSqrList] = useState(listOfSquareIds)
  const [currentSqr, setCurrentSqr] = useState(null)
  ...
  const markActive = id => {
    ...
    (currentSqr == id) ? setCurrentSqr(null) : setCurrentSqr(id)
  };
