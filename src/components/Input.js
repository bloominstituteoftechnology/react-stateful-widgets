...
export default function Input() {
  let [inputValue, setInputValue] = useState('') /* STEP 1 */
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: length.inputValue <= 10 ? 'royalblue': 'crimson' /* STEP 2 */
  };

  return (
    <div className='widget-input container'>
      <h2>Input</h2>
      <div id='output' style= {style} > text-transform: uppercase</div>
      <div>
        <input id='input' type='text' onChange={inputValue} /> {/* STEP 6 */}
