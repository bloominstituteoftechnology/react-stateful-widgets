...
{
  /* STEP 1 */
  //Declare state variable, set function, init to true
  ...
  const toggleSpinner = () => 
  {
    //toggle function makes the state 
  ...
  return (
    <div className='widget-spinner container'>
      ...
      {
        /* STEP 2 
         * spinnerOn represents state of this boolean*/
        spinnerOn && <div id='spinner' className='spinner'>--+--</div> 
      }
      
      {/* STEP 3 
        * Button displays hide or show upon click */}
      <button id='toggleSpinner' onClick={toggleSpinner}>
        {/* If spinnerOn is true, show the "hide" button, otherwise show "show"*/}
