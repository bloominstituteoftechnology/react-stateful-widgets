...
const initialMood = 'ambivalent';
const happyMood = 'Quite happy!';
const sadMood = 'being crushed by existantial dread';
...
export default function Moods() {
  ...
  return (
    <div className='widget-moods container'>
      <h2>Moods</h2>
      <div id='mood' style={style}>I am {mood} </div> 
      <div>
        <button id='makeHappy' onClick={makeHappy}>Happy</button>
        <button id='makeSad' onClick={makeSad}>Sad</button>
