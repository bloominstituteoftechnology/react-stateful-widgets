...
export default function Programmers() {
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: getNameOfFeatured != null ? 'gold' : 'royalblue' // 🤔 color turns to gold, when celebrating
  };
      ...
      <div className='programmers'>
        {
          ...
          // HELP NO IDEA, similiar to listofSquareIDs in Squares.js
