...
export default function Programmers() {
	...
	const [pioneersId, setPioneersId] = useState(null);
	...
	const getNameOfFeatured = () => {
		...
		// pioneers[pioneersId];
		return pioneers[pioneersId - 1].name;
		// console.log(pioneersId);
	};

	const style = {
		fontSize: "1.5em",
		marginTop: "0.5em",
		color: pioneersId === null ? "royalblue" : "gold", // 🤔 color turns to gold, when celebrating
	};
