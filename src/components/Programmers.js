...
export default function Programmers() {
  ...
  const programmerStyle = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: 'gold' // 🤔 color turns to gold, when celebrating
  };
  const noProgrammerStyle = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: 'royalblue' // color turn to royalblue, when no one is selected
  };
  ...
  return (
    <div className='widget-programmers container'>
      ...
      <div id='featured' style={programmerId != null ? programmerStyle : noProgrammerStyle}>
        {
          ...
          programmerId != null
            ? `🎉 Let's celebrate ${programmers.find(elm => elm.id == programmerId).name}! 🥳`
