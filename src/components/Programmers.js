...
export default function Programmers() {
  ...
  const [programmersValue, setProgrammersValue] = useState(listOfAwesome);
  ...
  const getNameOfFeatured = () => {
    ...
    return programmersValue[id - 1].name;
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featuredPerson != null ? 'gold' : 'royalblue' // 🤔 color turns to gold, when celebrating
  };
