...
export default function Programmers() {
  ...
  let [programmerName] = useState(listOfAwesome);
      ...
      <div className='programmers'>
        {
          ...
          listOfAwesome.map(dev =>
            <div className='programmer' key={dev.id}>
              {dev.name} <button onClick={() => { setFeatProgrammer({programmerName})/* in here set the featured id to be dev.id */ }}>Feature</button>
            </div>
          )
        }
      </div>
