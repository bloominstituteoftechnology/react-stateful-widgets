...
export default function Programmers() {
  ...
  if(programmerId === null) {
    ...
    const feautureProgrammer = programmers.find(programmer => {
      return programmerId === programmer.id
    })
    return feautureProgrammer.name
  };
};
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: programmerId !== null ? 'green' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
