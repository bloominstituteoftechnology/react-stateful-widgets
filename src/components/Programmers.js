...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    const featuredDev = programmers.find(
      (dev) => dev.id === activeProgrammerID
    );
  ...
  const style = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: activeProgrammerID ? "gold" : "royalblue", // 🤔 color turns to gold, when celebrating
  };
