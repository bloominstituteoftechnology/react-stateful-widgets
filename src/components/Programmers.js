...
export const listOfAwesome = [
  ...
  { id: '2', name: 'Evelyn Boyd Granville' },
  { id: '3', name: 'Mary Kenneth Keller' },
  { id: '4', name: 'Frances Allen' },
  { id: '5', name: 'Carol Shaw' },
];
...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    // I could have done -1, but I didn't understand why that started at 1. I guess from someone on the outside looking in maybe it makes sense.
    return (programmer[featured].name)
  };
