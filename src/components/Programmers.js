...
export default function Programmers() {
  ...
  const [programmers] = React.useState(listOfAwesome)
  const [featuredProgrammerId, setFeaturedProgrammerId] = React.useState(null)
  ...
  const getNameOfFeatured = () => {
    ...
    return programmers.find(dev => dev.id === featuredProgrammerId).name
  };
